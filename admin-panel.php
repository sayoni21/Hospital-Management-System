...
include('func.php');  
include('newfunc.php');
$con=mysqli_connect("localhost","root","1234","myhmsdb");
...
// echo "PID: " . (isset($_SESSION['pid']) ? $_SESSION['pid'] : 'Not set') . "<br>";
...
// echo "First Name: " . (isset($_SESSION['fname']) ? $_SESSION['fname'] : 'Not set') . "<br>";
// echo "Gender: " . (isset($_SESSION['gender']) ? $_SESSION['gender'] : 'Not set') . "<br>";
// echo "Last Name: " . (isset($_SESSION['lname']) ? $_SESSION['lname'] : 'Not set') . "<br>";
// echo "Contact: " . (isset($_SESSION['contact']) ? $_SESSION['contact'] : 'Not set') . "<br>";
    ...
    if((date("Y-m-d",$appdate1)==$cur_date and date("H:i:s",$apptime1)>$cur_time) or date("Y-m-d",$appdate1)>$cur_date) {
      $check_query = mysqli_query($con,"select apptime from appointmenttb where doctor='$doctor' and appdate='$appdate' and apptime='$apptime'");
        ...
        if (isset($_SESSION['pid'])) {
            ...
            echo "Session variable 'pid' is not set.";
            $pid = ''; // Handle the case where `pid` is not available
        }
